...
@EndUserText.label: 'Consumo de calidad'
...
define root view entity ZC_ChanCal_DHL
...
//    lchg_uname as LchgUname,
    _Documenta : redirected to composition child ZC_DOCCAL_DHL // Make association public   
